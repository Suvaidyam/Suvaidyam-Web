        ...
        <>
            ...
            <div className='lg:flex justify-center mt-16 lg:w-full '>
                <div className='bg-gray-50 lg:w-[480px] w-full lg:mx-3 lg:flex pb-7 items-center'>
                    <img src={encourage} alt="encourage" className='rounded-full lg:w-48  w-[170px]  px-6 py-5' />
                    <div className='lg:mt-5 lg:ml-0 ml-7'>
                        <p className='text-2xl'>WE ENCOURAGE</p>
                        <p className='mt-3 text-gray-400  text-[14px] font-thin lg:w-[230px] w-[260px] '>Where a child is born has a huge
                ...
                <div className='bg-gray-50 lg:w-[480px] lg:mx-3 lg:mt-0 mt-4 lg:flex pb-7 items-center'>
                    <img src={books} alt="Books" className='rounded-full lg:w-48 w-[170px] px-6 py-5' />
                    <div className='lg:mt-5 lg:ml-0 ml-7'>
                        <p className='text-2xl'>WE GUIDE</p>
                        <p className='mt-3 text-gray-400  text-[14px] font-thin lg:w-[220px] w-[260px]'>Along with providing quality
            ...
            <div className='lg:flex justify-center mt-4'>
                <div className='bg-gray-50 lg:w-[480px] lg:mx-3 lg:flex pb-7 items-center '>
                    <img src={desktop} alt="encourage" className='rounded-full lg:w-48 w-[170px] px-6 py-5' />
                    <div className='lg:mt-0 mt-4 lg:ml-0 ml-7'>
                        <p className='text-2xl'>WE INVEST</p>
                        <p className='mt-3 text-gray-400  text-[14px] font-thin lg:w-[240px] w-[260px]'>Introduce your team! Click here to add images,
                            text and links, or connect data from your collection.
                        </p>
                    </div>
                </div>
                <div className='bg-gray-50 lg:w-[480px] lg:mx-3 lg:flex pb-7 items-center'>
                    <img src={board} alt="encourage" className='rounded-full lg:w-48 w-[170px] px-6 py-5' />
