    ...
    <>
      <div className="w-full lg:flex lg:flex-row flex-col mt-20">
        ...
        <div>
          <img
            src={hand}
            alt="hand-img"
            className="w-full md:h-full h-[230px]  lg:bg-contain lg:w-[700px] lg:h-[750px]  bg-no-repeat"
          />
        </div>
        {/* our mission */}
      ...
      <div className="flex justify-center lg:mt-14">
        <div className="lg:mt-0 mt-7">
          <p className="lg:text-4xl text-bgblue opacity-90 lg:font-thin text-4xl">
            THE VISION{" "}
          </p>
      ...
      <div className='bg-slate-100  lg:w-full w-[full] lg:mx-0 mx-7 lg:mt-16 lg:flex lg:justify-end lg:ml-0 ml-7  '>
        <div className='lg:w-[460px] my-10 mb-10 lg:mx-0 mx-4'>
          <h1 className='text-3xl text-bgblue  lg:px-0 p-3'>WHO WE ARE</h1>
          <p className='my-7 font-fontspar lg:text-[18px] text-xl'>Amresh Kumar founded Suvaidyam in the summer of 20__ with the aim
