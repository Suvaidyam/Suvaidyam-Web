    ...
    <>
      ...
      <div className='w-full h-full'>
          ...
          <div className="w-full h-full  flex lg:flex-row flex-col">
            <div className="w-full lg:w-1/2 h-full flex flex-col justify-center gap-6 lg:gap-12 order-2 lg:order-1">
              ...
              <div className="w-full md:pr-4">
                <p className='text-white lg:text-[18px] md:text-[42px]  text-[21px] w-full font-thin'>I’m a paragraph. Use this space to tell people more about what you do and the services
        ...
        <div className='w-full text-center mt-16'>
          ...
          <hr className='lg:w-8 m-auto bg-black lg:h-1 md:h-2 md:mt-7 mt-14 md:w-20' />
        </div>
        ...
        <div className='w-full lg:flex lg:justify-center mt-16'>
          <div className='lg:mx-14  md:mx-8'>
            <div className='w-full flex justify-center md:mt-10 lg:mt-0'>
              <img src={gyan} alt='' className='rounded-full flex justify-center lg:w-full md:w-[500px] w-[250px] bg-cover ' />
            </div>
            <div className='w-full'>
              ...
              <div className='flex justify-center  mt-4'>
                <p className='lg:w-52 w-64 lg:mt-6 font-thin lg:text-base text-[20px] lg:mx-0 md:mx-32 md:w-fit  md:text-4xl'>I’m a paragraph. Double click me  or click Edit Text, it's easy.</p>
              </div>
            </div>
          </div>
          <div className='lg:mx-14 md:mx-8'>
              ...
              <p className='text-center md:text-3xl  text-blue-400 font-sans font-semibold lg:text-[13px] tracking-[3px] ml-5 mt-4'>Lorem Ipsum</p>
              <div className='w-full flex justify-center mt-4'>
                <p className='lg:w-[240px] w-[290px]  lg:mx-0 md:mx-30 md:w-fit  md:text-4xl lg:mt-6 font-thin lg:text-base text-[20px]'>I’m a paragraph. Double click me <span className='flex justify-center'> or click Edit Text, it's easy.</span></p>
              </div>
          </div>
          <div className='lg:mx-12 md:mx-8 '>
              ...
              <p className='text-center md:text-3xl   text-blue-400 font-sans font-semibold lg:text-[13px] tracking-[3px] mt-4'>Lorem Ipsum</p>
              <div className='flex justify-center mt-4'>
                <p className='lg:w-52 w-64  lg:mx-0 md:mx-32 md:w-fit  md:text-4xl lg:mt-6 font-thin lg:text-base text-[20px] '>I’m a paragraph. Double click  me  or click  Edit Text, it's easy.</p>
              </div>
          </div>
        </div>
        {/* team button */}
        <div className='w-full mt-20 flex justify-center'>
          <button className='outline-none duration-500  border-2 border-bgblue w-52 lg:w-52 md:w-64 text-bgblue h-10 text-[11.4px] font-bold tracking-[2px] hover:bg-bgblue hover:text-white'>JOIN THE TEAM</button>
        </div>
      </div>
    </>
  )
