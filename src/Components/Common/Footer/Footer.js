...
const Footer = () => {
  return (
    <>
      {/* footer */}
      <div className='flex lg:mx-44 mt-14'>
        <div>
          <h1 className='text-5xl font-serif text-bgblue font-light my-3'>SUPPORT US</h1>
          ...
          <div>
            <button className='border-2 border-bgblue w-32 h-10 hover:bg-white hover:text-bgblue font-bold
             text-[11px]  bg-bgblue text-white tracking-[2px] my-8
             '>DONATE</button>
          </div>
          {/* Address */}
          ...
          <div className='mt-4 lg:flex  w-full'>
            ...
            <div>
              <button className='border-2 border-bgblue mx-3 h-10 p-1'>Enter email address</button>
            </div>
            <div>
              <button className='border-2 tracking-[2px] border-bgblue w-24 h-10 p-1 text-bgblue  text-[12.5px]
              hover:bg-bgblue hover:text-white font-bold '>JOIN</button>
            </div>
          </div>
        </div>
      </div>
      {/* copywrite 2023 */}
      <div className='w-full bg-bgblue h-[70px] mt-14 opacity-80 '>
        <div className='lg:w-[350px] flex justify-end items-center lg:h-full'>
          <p className='text-white font-thin text-[13px]'>@ 2023 by Suvaidyam,City,State</p>
        </div>
      </div>
    </>
  )
